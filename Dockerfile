...
RUN apk add --no-cache --virtual .sys-deps \
  ...
  # Install PHP modules
    ...
    docker-php-ext-install pdo_mysql mysqli pdo_sqlite pgsql pdo_pgsql exif intl xsl soap zip mysqlnd json_post mbstring xmlrpc xmldiff opcache bz2 bcmath && \
